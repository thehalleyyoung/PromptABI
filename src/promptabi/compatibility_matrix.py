...
def _notes_for_check(check_name: str) -> str:
    return {
        ...
        "evaluation-harness-contracts": "checks finite benchmark prompt variables, few-shot role/token budgets, answer-parser schema assumptions, tokenizer/template pins, benchmark-tokenizer drift, provider/model metadata, and stop policies before evaluation scores are trusted",
