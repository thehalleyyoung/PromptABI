...
def _training_manifest_metadata(artifact: Artifact) -> tuple[tuple[str, object], ...]:
    ...
    metadata: list[tuple[str, object]] = [
        ...
        ("supervised_span_count", len(artifact.supervised_spans)),
        ("preference_pair_count", len(artifact.preference_pairs)),
        ("source_contribution_count", sum(len(span.source_contributions) for span in artifact.supervised_spans)),
