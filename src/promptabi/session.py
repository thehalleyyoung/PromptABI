...
CHECK_MODE_CATALOG: dict[str, tuple[CheckMode, ...]] = {
    ...
    "enterprise-access-control-hash-abstained": (CheckMode.ABSTAINING, CheckMode.COMPLETE),
    "enterprise-access-control-hash-mismatch": (CheckMode.SOUND, CheckMode.COMPLETE),
    "enterprise-access-control-incomplete": (CheckMode.SOUND, CheckMode.COMPLETE),
    "enterprise-access-control-retention-weak": (CheckMode.SOUND, CheckMode.COMPLETE),
    "enterprise-access-control-unapproved": (CheckMode.SOUND, CheckMode.COMPLETE),
    ...
    "prompt-pack-lock-missing": LOCKFILE_CHECK_MODES,
    "prompt-pack-lock-verified": LOCKFILE_CHECK_MODES,
    ...
    "prompt-pack-upgrade-compatible": LOCKFILE_CHECK_MODES,
    "prompt-pack-upgrade-diagnostic-regression": LOCKFILE_CHECK_MODES,
    "prompt-pack-upgrade-missing-pack": LOCKFILE_CHECK_MODES,
    "prompt-pack-upgrade-model-family-regression": LOCKFILE_CHECK_MODES,
    "prompt-pack-upgrade-package-regression": LOCKFILE_CHECK_MODES,
    "prompt-pack-upgrade-role-regression": LOCKFILE_CHECK_MODES,
    "prompt-pack-upgrade-stop-regression": LOCKFILE_CHECK_MODES,
    "prompt-pack-upgrade-template-regression": LOCKFILE_CHECK_MODES,
    "prompt-pack-upgrade-tool-schema-regression": LOCKFILE_CHECK_MODES,
    ...
    "evaluation-harness-answer-key-leakage": (CheckMode.SOUND, CheckMode.COMPLETE),
    "evaluation-harness-chain-of-thought-leakage": (CheckMode.SOUND, CheckMode.COMPLETE),
    "evaluation-harness-contract-missing": (CheckMode.ABSTAINING, CheckMode.COMPLETE),
    "evaluation-harness-cross-provider-incomplete": (CheckMode.BOUNDED, CheckMode.HEURISTIC),
    "evaluation-harness-cross-provider-mismatch": (CheckMode.BOUNDED, CheckMode.HEURISTIC),
    "evaluation-harness-cross-provider-report": (CheckMode.BOUNDED, CheckMode.HEURISTIC),
    ...
    "evaluation-harness-role-alternation-mismatch": (CheckMode.SOUND, CheckMode.COMPLETE),
    "evaluation-harness-stop-policy-mismatch": (CheckMode.SOUND, CheckMode.COMPLETE),
    "evaluation-harness-system-prompt-truncated": (CheckMode.SOUND, CheckMode.BOUNDED),
    "evaluation-harness-tool-unavailable": (CheckMode.SOUND, CheckMode.COMPLETE),
    "evaluation-harness-tokenizer-drift": (CheckMode.SOUND, CheckMode.BOUNDED),
    "evaluation-harness-tokenizer-mismatch": (CheckMode.SOUND, CheckMode.COMPLETE),
    "evaluation-harness-tokenizer-unpinned": (CheckMode.ABSTAINING, CheckMode.BOUNDED),
    ...
    "rag-tool-schema-composed": (CheckMode.SOUND, CheckMode.BOUNDED),
    "rag-tool-schema-field-forbidden": (CheckMode.SOUND, CheckMode.BOUNDED),
    "rag-tool-schema-field-missing": (CheckMode.SOUND, CheckMode.BOUNDED),
    "rag-tool-schema-missing": (CheckMode.SOUND, CheckMode.BOUNDED),
    "rag-tool-schema-truncated": (CheckMode.SOUND, CheckMode.BOUNDED),
