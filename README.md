...
| **Training/eval contracts** | target-role alignment, supervised span/loss-mask/source-leakage checks, tokenizer/template drift, and fixture-backed real-bug benchmarks |
