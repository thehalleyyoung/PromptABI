...
| **Training/eval contracts** | target-role alignment, dataset-packing boundaries, supervised loss-mask/source-leakage checks, tokenizer/template stage drift, and real-bug benchmarks |
