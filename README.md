...
| **Training/eval contracts** | target-role alignment, supervised span/loss-mask/source-leakage checks, fine-tuning tokenizer/template stage drift, and fixture-backed real-bug benchmarks |
