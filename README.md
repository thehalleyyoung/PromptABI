...
| **Prompt packs** | reusable prompt-library templates, locks, upgrade gates, public registries, signed provenance, and offline mirrors for role/tool/stop/model-family guarantees |
