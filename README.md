...
| **Prompt packs + contracts** | reusable templates and assume/guarantee contracts with compositional tokenizer/template/role/tool/stop/model-family/RAG/truncation guarantees, inherited proof-obligation lineage, locks, monotone extension certificates, transitive-lockfile registries, transparency logs, policy inheritance, trust tiers, signed offline mirrors, and deprecation/LTS lifecycles |
