...
| **Training/eval contracts** | target-role alignment, dataset-packing boundaries, supervised loss-mask/source-leakage checks, RLHF/DPO preference-pair fixture defects, tokenizer/template stage drift, and real-bug benchmarks |
