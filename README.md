...
| **Training/eval contracts** | target-role alignment, streaming-shard checks, data-loader adapters, synthetic-generator preflight, invalid roles/tools/JSON/stops, dataset packing, loss masks, source leakage, redacted witnesses, training-to-serving drift, RLHF/DPO defects, tokenizer/template drift, and real-bug benchmarks |
