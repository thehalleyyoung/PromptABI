...
| **Training/eval contracts** | target-role alignment, dataset packing, loss masks, source leakage, redacted witnesses, RLHF/DPO pair defects, tokenizer/template drift, and real-bug benchmarks |
