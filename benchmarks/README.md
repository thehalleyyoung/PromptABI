...
token-budget modeling, corpus-wide verification, cold/warm cache behavior, and
the labeled real-bug benchmark manifest.
...
PYTHONPATH=src promptabi corpus real-bug-benchmark
```
